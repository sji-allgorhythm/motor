        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-20">
                    <h2 class="text-xs text-primary tracking-widest font-medium title-font mb-1">ADVERTISEMENT</h2>
                    <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">See our Highlighted Products</h1>
                </div>
