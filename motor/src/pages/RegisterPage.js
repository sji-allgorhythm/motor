        ...
        <div class="w-full bg-stone-800 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="#">
              <div>
                <label for="name" class="block mb-2 text-md font-medium text-gray-300 dark:text-white">Your name</label>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="remember" class="text-gray-500 dark:text-gray-300">Join As seller</label>
                  </div>
                </div>
              </div>
              <button type="submit" class="w-full btn btn-primary text-gray-200">Register</button>
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                Already have an account? <Link to="/login" class="font-medium text-secondary hover:underline dark:text-primary-500">Sign in</Link>
              </p>
            </form>
          </div>
        </div>
